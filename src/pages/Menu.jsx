  ...
  return (
    <div className="container-content">
      ...
      <div className="page-body mt-4 flex gap-4">
        ...
        <div className="right hidden lg:block sticky top-[170px] self-start w-[33%] h-[500px] bg-surface rounded-md">
        <CartSidebar cartItems={cartItems} totalItems={totalItems} totalPrice={totalPrice}>
